package com.bookyard.booky.utils;
...
public class Const {
    ...
    public static final String TAG = "lool";

    //fragment switch types
    public static final String FRAGMENT_SWITCH_REPLACE = "REPLACE";
    ...
    //Fragment Tags
    public static final String CATEGORY_BOOKS_FRAG_TAG = "category_books";
    public static final String BOOK_DETAILS_FRAG_TAG = "book_details";
