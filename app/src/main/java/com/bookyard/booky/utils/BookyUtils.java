...
import com.bookyard.booky.ui.activities.LoginActivity;
...
public class BookyUtils {
    ...
    // Get DisplayDensity of screen
    public static float getDisplayDensity(Context context) {
        DisplayMetrics dm = context.getResources().getDisplayMetrics();
        return (float) dm.densityDpi;
    }

    // Just checks if location services on phone are enabled
